        ...
        <div class="container mx-auto px-4 py-8">
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full md:w-1/2 px-4 mb-8">
                    <img :src="`/storage/${service.image}`" alt="service"
                ...
                <div class="w-full md:w-1/2 px-4">
                    ...
                    <div class="mb-4">
                        <span v-if="service.price" class="text-gray-500">Price: ${{ service.price }}</span>
                    </div>
                    <div class="flex items-center mb-4">
                        <i class="fas fa-star"></i>
                        <span class="ml-2 text-gray-600">4.5 (120 reviews)</span>
                    </div>
                    <p v-if="service.description" v-html="getShortDescription(service.description)"
                        ...
                        <Modal ref="modal" title="Quick Checkout">
                            ...
                            <div v-else class="text-center my-20">
                                ...
                                <p class="mt-4 text-xl">
                                    First add service to the cart
                                </p>
                            </div>
                        </Modal>

                        <a v-if="service.demo_link" :href="service.demo_link"
