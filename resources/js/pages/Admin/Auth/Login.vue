<template>
    ...
    <div class="w-full mt-32 max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
        <div class="px-6 py-4">
            ...
            <p class="mt-1 text-center text-gray-500 dark:text-gray-400">Login your admin panel</p>

            <form @submit.prevent="submit">
                <InputText type="email" placeholder="Email address" v-model="form.email" :message="form.errors.email" />
