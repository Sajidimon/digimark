            ...
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                ...
                <form @submit.prevent="submit">
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="sm:col-span-2">
                            <ProductInput label="Demo URL" id="demo_link" placeholder="Enter Demo Link" type="text"
                                v-model="form.demo_link" />
                        </div>
                        <div class="sm:col-span-2">
                            <img class="w-32 h-24 rounded mb-5" id="image" v-if="imgPreview || props.product.image"
                                :src="imgPreview || `/storage/${props.product.image}`" alt="">
